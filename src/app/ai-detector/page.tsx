...
export default function AIDetectorPage() {
  ...
  return (
    <div className="min-h-screen bg-white relative">
      ...
      {/* Blue Background Container for Top Sections */}
        ...
        <section className="pt-6 sm:pt-8 pb-4 text-center relative z-10 px-4">
          <div className="text-center mb-6">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight animate-fade-in-up">
              <span className="text-slate-900">{t.heroTitle} </span>
              <span className="text-blue-600 italic">{t.heroTitleHighlight}</span>
            </h1>
          </div>
          <p className="text-slate-500 max-w-2xl mx-auto text-sm sm:text-base animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
            {t.heroSubtitle}
          </p>
        </section>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
          <div className="flex flex-col gap-8">
            ...
            <div className="w-full max-w-4xl mx-auto">
              {/* Upload Card */}
              <div
                className={`bg-white rounded-2xl border-2 border-dashed transition-all ${isDragging ? 'border-blue-500 bg-blue-50' : 'border-slate-200 hover:border-slate-300'
                ...
                {file ? (
                  <div className="text-center">
                    ...
                    <button
                      ...
                      className={`px-20 py-3.5 rounded-full font-semibold transition-all ${!isDetecting
      ...
      {/* Simplified CTA Banner - White background */}
      ...
      <section className="bg-blue-50 pt-12 sm:pt-16 pb-20 sm:pb-28">
