...
import { OPTIONS, UI_TEXT } from '@/lib/constants';
...
export default function EssayForm({ lang, onSubmit, initialTopic = '' }: EssayFormProps) {
    ...
    const handleAnalyze = async () => {
        ...
        // Simulate AI analysis with sequential field filling
        const demoData = {
            type: ESSAY_TYPES[0].value,
            academicLevel: ACADEMIC_LEVELS[2].value,
            ...
            <div className="max-w-4xl mx-auto animate-fade-in-up">
                ...
                <div className={isCollapsed ? 'mb-0' : 'mb-2'}>
                    {isCollapsed ? (
                        ...
                        // Expanded State - Title + Input box, no card wrapper
                        <>
                            {/* Header */}
                                ...
                                <div className="relative bg-white rounded-xl shadow-sm border border-slate-200 overflow-visible transition-colors">
                                    <div className="flex flex-col sm:flex-row sm:items-end">
                                        ...
                                        <div className="flex items-center justify-end gap-2 px-3 pb-3 sm:pb-2.5 sm:pr-3 sm:pl-0">
                                            ...
                                            <div className="relative group/upload">
                                                <button
                                                    type="button"
                                                    className="flex items-center gap-1.5 px-3 py-2 text-slate-500 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors border border-slate-200 hover:border-blue-300"
                                                >
                                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                ...
                                                <div className="absolute bottom-full right-0 mb-2 px-3 py-2 bg-slate-800 text-white text-xs rounded-lg opacity-0 invisible group-hover/upload:opacity-100 group-hover/upload:visible transition-all duration-200 w-[220px] text-center z-[60] shadow-lg pointer-events-none">
                                                    <div className="whitespace-normal">{t.autoFill.uploadTooltip}</div>
                                            ...
                                            >
                                                ...
                                                {!isAnalyzing && autoFillPrompt.trim() && (
                                                    <div className="absolute inset-0 bg-gradient-to-r from-blue-400/0 via-white/30 to-purple-400/0 animate-shimmer"></div>
                                                )}
                                                {isAnalyzing ? (
                                                    <>
                                    ...
                                    {isAnalyzing && (
                                        <div className="absolute inset-0 pointer-events-none overflow-hidden rounded-xl">
                                            <div className="absolute top-0 left-0 w-full h-1 bg-blue-400/50 shadow-[0_0_15px_rgba(59,130,246,0.6)] animate-scan"></div>
                                        </div>
                                    )}
                                </div>
                            </div>
                        ...
                        >
                            <div className="bg-slate-50 border-b border-slate-100 px-4 py-2 flex items-center justify-between min-h-[44px]">
                                ...
                                <div className="relative group/attach">
                                    <button
                                        type="button"
                                        className="text-[11px] font-bold text-blue-600 hover:text-blue-700 bg-white border border-slate-200 hover:border-blue-300 px-3 py-1.5 rounded-lg shadow-sm transition-all flex items-center gap-1.5 active:scale-95"
                                    >
                                    ...
                                    {/* Tooltip */}
                                    <div className="absolute bottom-full right-0 mb-2 px-3 py-2 bg-slate-800 text-white text-xs rounded-lg opacity-0 invisible group-hover/attach:opacity-100 group-hover/attach:visible transition-all duration-200 w-[220px] text-center z-50 shadow-lg">
                                        <div className="whitespace-normal">{t.form.attachRefTooltip}</div>
                                        <div className="absolute top-full right-4 border-4 border-transparent border-t-slate-800"></div>
                                    </div>
                                </div>
                            </div>
